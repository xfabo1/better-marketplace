    ...
    <footer className="bg-white border-t border-gray-100">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-medium text-gray-900">Better Marketplace</h3>
            <p className="mt-2 text-sm text-gray-600">
              The modern way to buy and sell items online.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link href="/category/cars" className="text-sm text-gray-600 hover:text-primary">
                  Cars & Vehicles
                </Link>
              </li>
              <li>
                <Link href="/category/electronics" className="text-sm text-gray-600 hover:text-primary">
                  Electronics
                </Link>
              </li>
              <li>
                <Link href="/category/home" className="text-sm text-gray-600 hover:text-primary">
                  Home & Garden
                </Link>
              </li>
              <li>
                <Link href="/category/clothing" className="text-sm text-gray-600 hover:text-primary">
                  Clothing & Fashion
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="text-sm font-medium text-gray-900 uppercase tracking-wider">Legal</h3>
            <ul className="mt-4 space-y-2">
              <li>
        ...
        <div className="mt-12 border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} Better Marketplace. All rights reserved.
          </p>
